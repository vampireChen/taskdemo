...
jQuery.fn.pagination = function(maxentries, opts){
	...
	return this.each(function() {
		...
		function drawLinks() {
            ...
            var selectItems_per_page='<span>每页显示</span><select  id="per_page" onchange="changeLimit();"><option value="10">10</option> <option value="25">25</option><option value="50">50</option><option value="100">100</option><option value="200">200</option> </select><span>条记录</span>';
            $(pagetext).appendTo(panel);
            $(toPage).appendTo(panel);
            $(selectItems_per_page).appendTo(panel);
